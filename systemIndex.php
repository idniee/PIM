            ...
            <div class="main-nav d-none d-lg-block pim">
              <nav class="site-navigation text-right text-md-center" role="navigation">
                <ul class="site-menu js-clone-nav d-none d-lg-block active1">      <!--class active1 on css/menubuttonsystemindex.css for centering the text-->
                  ...
                  <?php if($_SESSION['userjob'] == 'Manager' || $_SESSION['userjob'] == 'Administrator') { ?>
                  <li class="#"><a href="chart.php">REPORT</a></li>
                <?php } ?>
                </ul>
              </nav>
            </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <p>
                          <div class="icons">
                            <div class="dropdown1">
                              <button onclick="dropfunctioninventory()" class="dropbtn1">
                                <i class="icon-th-large" ></i>
                                  <span class="tooltiptext">Iventory</span>
                                    <div id="inventory" class="dropdown-content1 bgopacity">
                                      <a href="crud/updel.php"><i class="icon-th-list"></i>
                                        <p style="font-size:16px; color:black;">List Product</p></a>
                                      <?php if($_SESSION['userjob'] != 'Administrator'){ ?>
                                      <a href="crud/stockList.php"><i class="icon-upload"></i>
                                        <p style="font-size:16px; color:black;">List Stock</p></a>
                                      <?php }else{ ?>
                                        <a href="updateSite.php"><i class="icon-upload"></i>
                                          <p style="font-size:16px; color:black;">Update Front Website</p></a>
                                      <?php } ?>
                                      <?php if($_SESSION['userjob'] != 'Administrator'){ ?>
                                      <a href="productadd.php"><i class="icon-plus-circle"></i>
                                        <p style="font-size:16px; color:black;">Add Product</p></a>
                                      <?php } ?>  
                                      <?php if($_SESSION['userjob'] != 'Administrator'){ ?>
                                      <a href="scanner/checkOut.php"><i class="icon-edit"></i>
                                        <p style="font-size:16px; color:black;">Checkout Stock</p></a>
                                      <?php } ?>
                                    </div>
                              </button>
                            </div>
                      ...
                      <?php if($_SESSION['userjob'] == 'Manager') {?>
                      <td>
                        <p>
                          <div class="icons">
                            <div class="dropdown1">
                              <button class="dropbtn1" onclick="dropfunctionstaff()">
                                <i class="icon-user"></i>
                                  <span class="tooltiptext">Staff</span>
                                    <div id="staff" class="dropdown-content1 bgopacity">
                                      <a href="staffList.php"><i class="icon-list-alt"></i>
                                        <p style="font-size:16px; color:black;">Staff List</p></a>
                                      <a href="signUp.php"><i class="icon-plus-circle"></i>
                                        <p style="font-size:16px; color:black;">Add Staff</p></a>
                                      <a href="staffprofile.php"><i class="icon-minus-circle"></i>
                                        <p style="font-size:16px; color:black;">Remove Staff</p></a>
                                    </div>
                              </button>
                            </div>
                          </div>
