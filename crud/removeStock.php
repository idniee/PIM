<?php
// to jump to next page define the $to to ur url
 ...
 <link rel="stylesheet" href="../sweetalert2/dist/sweetalert2.min.css">
   ...
   <body>
     <?php if(isset($_SESSION['usersession'])){
			   ...
			   $stockID = $_SESSION['userStore'].$_GET['p'];
			   $sqldelete = "DELETE FROM stock WHERE stock_ID = '".$stockID."' ";
			   ...
			   if($result>0){
			 		echo " <script>
			 	  Swal.fire({
			 	 title: 'Stock Successfully Removed!',
			 	 text: 'Redirecting',
			 	 icon: 'success',
