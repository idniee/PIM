              ...
              <div class="row">
                <?php
                  while($data = $result->fetch_assoc()){
                    $pp = number_format($data['prod_Price'], 2);
                    echo "<div class='col-sm-2 col-lg-4 text-center item mb-4'>";?>
                    <a href="productSingle.php?productID=<?php echo $listProd[$count]['prod_ID']; ?>"> <?php
                    echo "<img class= 'w-75 h-75' src='{$data['prod_Pic']}'>";
                    echo "<h3 class='text-dark'><a href='shop-single.html'>{$data['prod_Name']}</a></h3>";
                    echo "<p class='price'>RM{$pp}</p>";
                    echo "</div>";
                  }
                }
              }?>
