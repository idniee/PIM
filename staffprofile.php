...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="">
      ...
      <div class="container col-lg-11 col-sm-5">
                ...
                <?php if(mysqli_num_rows($result) > 0){?>
                  <?php while ($row = $result-> fetch_assoc()) { ?>
                    <tr>
                            ...
                            <td><button style="color:black;" onclick="confirmDialog(this)" type="button" value="<?php echo $row['emp_ID']; ?>">Delete</button></td>
                            <script >
                            function confirmDialog(e){
                              ...
                              Swal.fire({
                                  ...
                                  if (result.isConfirmed) {
                                    window.location = 'deleteStaff.php?empid=' + id;
                                  }
                                })
                            }
                            </script>
