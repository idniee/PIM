...
<div class="topright">
<div class="dropdown">
  <img style="padding:10px" src="images/contact/setting.png" alt="" width="90" height="65">
  <div class="dropdown-content">
  <a href="change-password.php"><img src="images/contact/lock.png" width="20" height="20"> Change Password</a>
  <a href="editprofile.php"><img src="images/contact/profile.png" width="20" height="20"> Edit Profile</a>
  </div>
</div>
</div>
  ...
  <div class="row">
    <div class="col-md-6 col-lg-5 mb-4 mb-lg-0">
      ...
      <div class="block-7">
        ...
        <h5 style="color:black;"class="sub-title">EMAIL : <?php echo $user['emp_Email'];?></h5><br>
        <h5 style="color:black;"class="sub-title">Date Of Birth : <?php echo $user['emp_DOB'];?></h5><br>
      </div>
    </div>
    ...
    <div class="col-lg-6 mx-auto mb-4 mb-lg-0">
      ...
      <br><br><br>
      <h5 style="color:black;"class="sub-title">Address : <?php echo $user['emp_Add'];?></h5><br>
